...
let g:= add_mono_map_grid g (2,3) (3,3)
let g:= add_mono_map_grid g (2,5) (3,5)
let s:= g.struct.edges[54]?
match s with
  |none => IO.println "the proof is wrong"
  |some s => ProofInEnglish g s.mono.2